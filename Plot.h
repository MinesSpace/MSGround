...
namespace
{
    ...
    Q_GLOBAL_STATIC_WITH_ARGS(const QString, GYRO_X_TITLE, ("Gyro_X"));
    Q_GLOBAL_STATIC_WITH_ARGS(const QString, GYRO_Y_TITLE, ("Gyro_Y"));
    Q_GLOBAL_STATIC_WITH_ARGS(const QString, GYRO_Z_TITLE, ("Gyro_Z"));
}
